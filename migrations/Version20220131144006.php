...
final class Version20220131144006 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE reservation (id INT AUTO_INCREMENT NOT NULL, passenger_id INT DEFAULT NULL, road_trip_id INT DEFAULT NULL, INDEX IDX_42C84955C3423909 (driver_id), INDEX IDX_42C849554502E565 (passenger_id), INDEX IDX_42C84955FBF41406 (road_trip_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
