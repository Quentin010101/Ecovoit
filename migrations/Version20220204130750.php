 ...
 */
final class Version20220204130750 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE road_trip CHANGE trip_date trip_date DATE NOT NULL');
    }
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE road_trip CHANGE trip_date trip_date DATETIME NOT NULL');
    }
}
